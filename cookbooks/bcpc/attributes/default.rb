...
default['bcpc']['repos']['elasticsearch'] = 'http://packages.elastic.co/elasticsearch/2.x/debian'
default['bcpc']['repos']['kibana'] = 'http://packages.elastic.co/kibana/4.6/debian'
